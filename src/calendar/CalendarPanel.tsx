...
import { addDays, dayStart, weekStart, onDay, sameDay, layoutDay, eventTitle, type CalendarEvent } from './model';
...
export const eventTime = (e: CalendarEvent) => e.allDay ? tr("Весь день") : `${time(e.start)}–${time(e.end)}`;
