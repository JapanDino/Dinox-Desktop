...
// Legacy exit callers restore only changes owned by the controller.
pub fn set_taskbar_visibility(visible: bool, _always_on_top: bool) {
    if visible { crate::shell_controller::restore(); }
}
