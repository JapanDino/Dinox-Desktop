...
pub static CURRENT_AUDIO_READY: AtomicBool = AtomicBool::new(false);
pub static CURRENT_MUTED: AtomicBool = AtomicBool::new(false);
pub static BRIGHTNESS_AVAILABLE: AtomicBool = AtomicBool::new(false);
